...
bool VulkanRenderer::Render()
{
    ...
    // Rendering Commands
    {
        ...
        vkCmdClearColorImage(cmd, m_VkContext->swapchainImages[imageIndex], VK_IMAGE_LAYOUT_PRESENT_SRC_KHR, &clearColorValue, 1, &subresourceRange);
    }
